...
export function allStatuses(name, iconSize = 200) {
  return [{
        ...
        {
          maxProgress: 0.8,
          text: name + " αν εχεις φτάσει μέχρι εδώ ζωντανός/ή υπάρχουν πολλές πιθανότητες να ολοκληρώσεις την αποστολή σου μέχρι τέλους. Έχεις φάει το περισσότερο damage και φαίνεται να αντέχεις το φορτίο.",
          status: "Pro",
          icon: <Status4 className={styles.avatar} width={`${iconSize}px`} height={`${iconSize}px`} />
        },
        {
          maxProgress: 1.0,
          text: name + " έχεις μάθει όλες τις διαδικασίες του PS και είσαι έτοιμος/η να μεταλαμπαδεύσεις τις γνώσεις σου στον επόμενο τυχερό/η. Ετοιμάζεσαι να επιστρέψεις στην ηρεμία και την ασφάλεια της ομάδας σου.",
          status: "Survivor",
